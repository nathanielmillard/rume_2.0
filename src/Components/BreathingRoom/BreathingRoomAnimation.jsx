...
export const inhaleExhale = (mood) => {
  ...
  const tl1 = gsap.timeline({ repeat: 25, yoyo: true })
  tl1.to('#one', {
    duration: 5,
    scale: 2,
  ...
  const tl2 = gsap.timeline({ repeat: 25, yoyo: true })
  tl2.to('#two', {
    duration: 5,
    scale: 4,
  ...
  const tl3 = gsap.timeline({ repeat: 25, yoyo: true })
  tl3.to('#three', {
    duration: 5,
    scale: 6,
  ...
  const tl4 = gsap.timeline({ repeat: 25, yoyo: true })
  tl4.to('#four', {
    duration: 5,
    scale: 9,
  ...
  const tl5 = gsap.timeline({ repeat: 25, yoyo: true })
  tl5.to('#five', {
    duration: 5,
    scale: 12,
